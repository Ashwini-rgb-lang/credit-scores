...
<section class="services-section">
  <div class="container">
    ...
    <p class="section-subtitle">
      We provide a wide range of loan solutions to meet your personal and business financial needs.
    </p>

    <div class="services-grid">

      <div class="service-card">
        <img src="https://images.unsplash.com/photo-1605902711622-cfb43c4437b5" alt="Personal Loan">
        <h3>Personal Loan</h3>
        <p>Quick unsecured loans for medical emergencies, travel, weddings, or any personal financial needs.</p>
      </div>

      <div class="service-card">
        <img src="https://images.unsplash.com/photo-1560518883-ce09059eeffa" alt="Home Loan">
        <h3>Home Loan</h3>
        <p>Affordable home financing solutions to help you buy, construct, or renovate your dream home.</p>
      </div>

      <div class="service-card">
        <img src="https://images.unsplash.com/photo-1553729459-efe14ef6055d" alt="Business Loan">
        <h3>Business Loan</h3>
        <p>Financial support for startups, MSMEs, and growing businesses for expansion and working capital.</p>
      </div>

      <div class="service-card">
        <img src="img/car_loan.jpg" alt="Car Loan">
        <h3>Car Loan</h3>
        <p>Easy vehicle financing options for new or used cars with quick approval and convenient EMI plans.</p>
      </div>

      <div class="service-card">
        <img src="https://images.unsplash.com/photo-1523580494863-6f3031224c94" alt="Education Loan">
        <h3>Education Loan</h3>
        <p>Financial assistance for students to pursue higher education in India or abroad.</p>
      </div>

      <div class="service-card">
        <img src="img/Gold_loan.jpg" alt="Gold Loan">
        <h3>Gold Loan</h3>
        <p>Get instant funds by pledging your gold ornaments with minimal documentation.</p>
      </div>

      <div class="service-card">
        <img src="https://images.unsplash.com/photo-1600585154340-be6161a56a0c" alt="Loan Against Property">
        <h3>Loan Against Property</h3>
        <p>Secure large loan amounts by mortgaging residential or commercial property.</p>
      </div>

      

      <div class="service-card">
        <img src="img/car_loan1.jpg" alt="Two Wheeler Loan">
        <h3>Loan Against Mutual Fund</h3>
        <p>Purchase your dream bike with easy financing options and affordable EMI plans.</p>
      </div>
